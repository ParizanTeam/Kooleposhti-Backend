...
c = Course.objects.create(
    instructor_pk=2, categories=[1,4], title='تفریحات سالم', price=20000, rate=4, 
...
c = Course.objects.create(
    instructor_pk=2, categories=[6], title='کتابخوانی', price=45000, rate=5, 
...
c = Course.objects.create_user(
    instructor_pk=4, categories=[4,11], title='شطرنج مبتدی', price=200000, rate=1.5, 
...
"""
c = Course.objects.create_user(
    instructor_pk=1, categories=[4,8], title='آموزش کیک پزی', price=39000, rate=5, 
...
c = Course.objects.create(
    instructor_pk=2, categories=[6], title='تند خوانی', price=150000, rate=3.2, 
...
"""
c = Course.objects.create(
    instructor_pk=2, categories=[1,7,2], title='آشنایی با معماری', price=250000, rate=2.5, 
...
c = Course.objects.create_user(
    instructor_pk=1, categories=[4,8,2], title='آموزش شیرینی پزی', price=45000, rate=4.3, 
...
"""
c = Course.objects.create_user(
    instructor_pk=3, categories=[4,11], title='شطرنج پیشرفته', price=200000, rate=1.5, 
...
c = Course.objects.create_user(
    instructor_pk=6, categories=[2], title='دوره مراقبت پوست و زیبایی', price=220000, rate=4.4, 
